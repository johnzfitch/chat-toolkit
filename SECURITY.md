...
The current development version is 1.6.7. Security fixes target the current version; no response-time or older-version maintenance commitment is implied.
